                    ...
                    <div class="ibox-content">
                        <div class="flex-margin">
                            <section class="box gray">
                                <div class="top-bar">
                                    <h1>Web ui42</h1>
                                    <a href="https://www.ui42.com/" target="_blank"><button class="btn active">Otvoriť</button></a>
                                </div>
                                <p>&#8226; Na webe nájdeš okrem iného fotky kolegov či blogy o zaujímavých témach</p>
                            </section>

                            <section class="box">
                                <div class="top-bar">
                                    <h1>BUXUS web</h1>
                                    <a href="https://www.buxus.sk/" target="_blank"><button class="btn active">Otvoriť</button></a>
                                </div>
                                <p>&#8226; Zisti viac o tak často spomínanom BUXUSe</p>
                            </section>
