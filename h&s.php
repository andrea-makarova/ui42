                ...
                <div class="ibox row">
                    <div class="ibox-title col-xs-10">
                        <ul class="breadcrumbs">
                            <li><span>Zdieľané disky</span></li>
                        </ul>
                    </div>
                        ...
                        <div class="flex-margin">
                            <section class="box gray">
                                <div class="top-bar no-border">
                                    <h1>Windows XP</h1>
                                    <a href="http://support.microsoft.com/kb/308582/sk" target="_blank"><button class="btn active">Otvoriť</button></a>
                                </div>
                            </section>
                            ...
                            <section class="box">
                                <div class="top-bar no-border">
                                    ...
                                    <a href="http://windows.microsoft.com/sk-sk/windows7/create-a-shortcut-to-map-a-network-drive" target="_blank"><button class="btn active">Stiahnuť</button></a>
                                </div>
                            </section>
                            <section class="box gray">
                                <div class="top-bar no-border">
                                    <h1>MAC OS X</h1>
                                    <a href="http://support.apple.com/kb/PH7116" target="_blank"><button class="btn active">Otvoriť</button></a>
                                </div>
                            </section>
                        </div>
